...
class massBalanceDialog(QDialog):
    ...
    def createwidgets(self):
        ...
        ######### energy auto fill##############
        self.ps_feedamount_LE.editingFinished.connect(self.fillbiomass)

        self.in_biomass_LE.textChanged.connect(self.filliptotal)
    ...
    def fillbiomass(self):
        self.in_biomass_LE.setText(self.ps_feedamount_LE.text())
